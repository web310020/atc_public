...
--workers 8 容易 OOM, 不行就先降到 2-3.

Usage:
    cd papers_src/belief_v3/
    ...
    python run_k5_probe_workers8.py \\
    ...
    python run_k5_probe_workers8.py --seed-end 19 --workers 3

    # Sanity-only quick test (less steps, fewer seeds):
    python run_k5_probe_workers8.py --seed-end 3 --steps 30000 --workers 2 \\
