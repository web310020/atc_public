...
Usage:
    # 默认: seeds 30..49, workers=1, template A, 120K steps/seed/mode
    python run_k3_seedbump_workers1.py \
    ...
    # 只跑 ATC:
    python run_k3_seedbump_workers1.py --modes proposed --workers 1
...
def main() -> int:
    p = argparse.ArgumentParser(
        description="K=3 seed-bump parallel runner (workers=1 by default)")
